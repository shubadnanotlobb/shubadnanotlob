...
// ============================================================
// RENDER RESTAURANTS (مع الشكل الجديد: الخلفيةصورة واللوجو يمين أعلى)
// ============================================================
...
function renderRestaurantsList(searchQuery = "") {
  ...
  filtered.forEach(r => {
    ...
    card.innerHTML = `
      <img class="restaurant-bg-img" src="${r.logo || 'https://via.placeholder.com/400x200'}" alt="${r.name || ""}">
      <img class="restaurant-logo-badge" src="${r.logo || 'https://via.placeholder.com/100'}" alt="Logo">
...
// ============================================================
// LISTEN TO RESTAURANTS (تحديث صفحة الآدمن أيضاً لعرض التصميم الجديد المصغر)
// ============================================================
        ...
        if (adminRestContainer) {
          ...
          item.innerHTML = `
            <div style="display: flex; align-items: center; gap: 8px; overflow: hidden;">
              <img src="${data.logo || 'https://via.placeholder.com/40'}" style="width: 35px; height: 35px; border-radius: 50%; object-fit: cover; border: 1px solid #ddd;">

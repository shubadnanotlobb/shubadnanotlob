...
function performAdminLogin() {
    const userInput = document.getElementById('loginUsername') || document.getElementById('loginusername') || document.getElementById('loginEmail');
    const passInput = document.getElementById('loginPassword');

    // اسم المستخدم وكلمة المرور الرسمية المعتمدة
...
// Global Export Assignment لربط أحداث HTML

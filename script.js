...
<div class="app-container">
    ...
    <header class="app-header">
        <div style="display: flex; align-items: center; gap: 8px;">
            <button class="back-btn" id="backBtn" onclick="goBack()" aria-label="Back" style="display: none;">
                <svg viewBox="0 0 24 24" style="width: 22px; height: 22px; fill: none; stroke: currentColor; stroke-width: 2.5;">
    ...
    <!-- Default Brand Section (Home Page) -->
    <div class="logo-section" id="defaultLogoSection" style="text-align: center;">
        <div class="logo-circle-glow" style="display: inline-block;">
        ...
        <h1 class="brand-text" style="text-align: center; margin-top: 6px;">Shu Badna <span style="color: var(--primary-teal, #008080);">Notlob</span></h1>
        <p class="brand-slogan" style="text-align: center; margin-top: 2px;">دليلك الأول للمطاعم والخدمات السريعة</p>
    </div>

    <!-- Categories Header (Sub-Pages) -->
    <div class="categories-header-section" id="categoriesHeaderSection" style="display: none;">
    ...
    <div class="view-page active" id="pageHome">
        ...
        <br>
        <div class="feature-pill" style="text-align: center; font-weight: 800; color: var(--primary-teal, #008080);">
    ...
    <div class="view-page" id="pageLogin">
        <div class="admin-box glass-panel">
            <h3 style="margin-bottom: 15px; color: var(--primary-teal, #008080); font-size: 16px;">Admin Authentication</h3>
    ...
    <div class="view-page" id="pageAdmin">
        <div class="admin-box glass-panel">
            <h3 id="categoryFormTitle" style="color: var(--primary-teal, #008080); font-size: 15px; margin-bottom: 12px;">Add / Edit Category</h3>
            ...
            <div style="display: flex; gap: 8px;">
                <button class="admin-btn" type="button" onclick="saveCategoryToFirebase()">Save Category</button>
                <button class="admin-btn" type="button" style="background: #777;" onclick="resetCategoryForm()">Reset</button>
            </div>
            <h4 style="color: var(--primary-teal, #008080); font-size: 13px; margin-top: 15px; margin-bottom: 10px;">Active Categories List</h4>
            <div id="adminManageCategoriesContainer"></div>
        </div>

        <div class="admin-box glass-panel">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                <h3 id="formTitle" style="color: var(--primary-teal, #008080); font-size: 15px;">Add New Restaurant</h3>
                <button class="admin-btn admin-btn-logout" type="button" style="width: auto; padding: 6px 12px; font-size: 11px; margin-top: 0;" onclick="logoutAdmin()">Logout</button>
            </div>
            ...
            <div style="display: flex; gap: 8px;">
                <button class="admin-btn" type="button" onclick="saveRestaurantToFirebase()">Save Restaurant</button>
                <button class="admin-btn" type="button" style="background: #777;" onclick="resetAdminForm()">Reset</button>
            </div>
        </div>

        <div class="admin-box glass-panel">
            <h4 style="color: var(--primary-teal, #008080); font-size: 13px; margin-bottom: 10px;">Active Firebase Restaurants</h4>
    ...
    <!-- Footer في الأسفل دائماً مع رابط صفحة الأدمن -->
    <footer class="app-footer" onclick="checkAdminAccess()" style="position: fixed; bottom: 0; left: 0; width: 100%; text-align: center; padding: 12px 10px; font-size: 11px; color: #666; background: #ffffff; cursor: pointer; border-top: 1px solid #eee; z-index: 1000;">

...
container.innerHTML += &lt;div class="category-card" data-ar="${cat.titleAr}" data-en="${cat.titleEn}" onclick="openRestaurants('${cat.titleAr}', '${cat.titleEn}', '${cat.imgUrl}')">
<img class="cat-img" src="${cat.imgUrl}" alt="${cat.titleAr}" onerror="this.src='assets/logo.png'">
<div class="cat-info">
<div class="cat-title-ar">${cat.titleAr}&lt;/div&gt; &lt;div class="cat-title-en"&gt;${cat.titleEn} • <span style="color: var(--primary-teal, #0f4c5c); font-weight: bold;">(${count})&lt;/span&gt;&lt;/div&gt; &lt;/div&gt; &lt;div class="cat-arrow"&gt;&lsaquo;&lt;/div&gt; &lt;/div&gt;;
});
}
...
container.innerHTML += &lt;div class="admin-rest-item" style="display:flex; justify-content:space-between; align-items:center; padding:8px; border-bottom:1px solid #eee;"&gt; &lt;div style="display:flex; align-items:center; gap:8px;"&gt; &lt;span style="background:#0f4c5c; color:#fff; padding:3px 8px; border-radius:6px; font-weight:bold; font-size:12px;"&gt;#${index + 1}</span>
<div>
<strong style="font-size:13px; color:#141414;">${cat.titleAr}&lt;/strong&gt; &lt;br&gt;&lt;small style="color:#0f4c5c; font-weight:700;"&gt;${cat.titleEn} (${count})&lt;/small&gt; &lt;/div&gt; &lt;/div&gt; &lt;div style="display:flex; gap:4px; align-items:center;"&gt; &lt;button onclick="moveCategory(${index}, -1)" style="background:#0f4c5c; color:#fff; border:none; padding:4px 8px; border-radius:4px; cursor:pointer; font-weight:bold;">▲</button>
<button onclick="moveCategory(${index}, 1)" style="background:#0f4c5c; color:#fff; border:none; padding:4px 8px; border-radius:4px; cursor:pointer; font-weight:bold;"&gt;▼&lt;/button&gt; &lt;button onclick="editCategory('${cat.id}')" style="background:#555; color:#fff; border:none; padding:5px 8px; border-radius:6px; font-weight:700; cursor:pointer; font-size:11px;">Edit</button>
<button onclick="deleteCategory('${cat.id}')" style="background:#d32f2f; color:#fff; border:none; padding:5px 8px; border-radius:6px; font-weight:700; cursor:pointer; font-size:11px;"&gt;Delete&lt;/button&gt; &lt;/div&gt; &lt;/div&gt;;
});
}
...
container.innerHTML += &lt;div class="admin-rest-item"&gt; &lt;div&gt; &lt;strong style="font-size:13px; color:#141414;"&gt;${rest.name}</strong>
<br><small style="color:#0f4c5c; font-weight:700;">${rest.category}&lt;/small&gt; &lt;/div&gt; &lt;div style="display:flex; gap:6px;"&gt; &lt;button onclick="editRest('${docSnap.id}')" style="background:#0f4c5c; color:#fff; border:none; padding:5px 10px; border-radius:6px; font-weight:700; cursor:pointer; font-size:11px;">Edit</button>
<button onclick="deleteRest('${docSnap.id}')" style="background:#d32f2f; color:#fff; border:none; padding:5px 10px; border-radius:6px; font-weight:700; cursor:pointer; font-size:11px;"&gt;Delete&lt;/button&gt; &lt;/div&gt; &lt;/div&gt;;
});
} catch (err) {
...
container.innerHTML += &lt;div class="restaurant-card" style="cursor: pointer;"&gt; &lt;div class="rest-top-content" onclick="openRestaurantProfile(${index})">
<img class="rest-icon" src="${logoSrc}" alt="Logo" onerror="this.onerror=null; this.src='${defaultFallbackLogo}';">
<div class="rest-info">
<h4>${rest.name}&lt;/h4&gt; &lt;p&gt;${rest.desc}</p>
</div>
</div>
<div class="rest-actions">
<a href="${rest.menuUrl}" target="_blank" class="action-btn btn-menu" onclick="event.stopPropagation();"&gt;MENU&lt;/a&gt; &lt;a href="https://wa.me/${rest.phone}" target="_blank" class="action-btn btn-contact" onclick="event.stopPropagation();">CONTACT</a>
<a href="${rest.mapUrl}" target="_blank" class="action-btn btn-location" onclick="event.stopPropagation();"&gt;LOCATION&lt;/a&gt; &lt;/div&gt; &lt;/div&gt;;
});
}

                ...
                Object.keys(data).forEach((id) => {
                    ...
                    if (adminCatContainer) {
                        ...
                        div.innerHTML = `
                            ...
                            <div>
                                <button type="button" style="padding: 4px 8px; background: #008080; color: white; border: none; border-radius: 4px; cursor: pointer; margin-left: 5px;" onclick="window.editCategory('${id}', '${item.nameAr || ''}', '${item.nameEn || ''}', '${item.imgUrl || ''}')">تعديل</button>
